...
| Blind-review a Chinese CS master's or doctoral thesis | [thesis_review](thesis_review/) | Three- or five-reviewer independent reports, chair adjudication, full-document anonymity and physical-page pagination audits, and a revision ledger |
...
| [thesis_review](thesis_review/) | Run institution-aware, independent 3/5-reviewer simulations with full-document blind-copy identity checks and a mandatory physical-page/forced-float ledger |
